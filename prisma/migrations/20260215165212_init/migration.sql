...
-- CreateIndex
CREATE INDEX "event_logs_market_id_seq_idx" ON "event_logs"("market_id", "seq");
...
-- AddForeignKey
ALTER TABLE "event_logs" ADD CONSTRAINT "event_logs_market_id_fkey" FOREIGN KEY ("market_id") REFERENCES "markets"("id") ON DELETE SET NULL ON UPDATE CASCADE;
